...
- Построение двух графиков: `plot_time.png` (время от размера) и `plot_performance.png` (производительность умножения матриц)
...
![График производительности](plot_perfomance.png)
