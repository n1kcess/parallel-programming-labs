...
- Запуск через mpirun -np с разным количеством процессов
...
- Построение трёх графиков: `plot_time.png` (время от размера для разных количеств процессов), `plot_speedup.png` (ускорение относительно 1 процесса) и `plot_efficiency.png` (эффективность использования процессов)
